...
def graph_schema_consolidation(graph):
    """
    DEPRECATED: Bu fonksiyon sigorta domain'ine özel prompt kullanıyordu.
    Dinamik graph yapısına geçildiği için artık kullanılmamaktadır.
    """
    logging.warning("graph_schema_consolidation() is deprecated and no longer functional.")
    return None
