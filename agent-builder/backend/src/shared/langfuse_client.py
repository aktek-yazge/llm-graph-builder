# -*- coding: utf-8 -*-
"""
Langfuse Client - Centralized LLM Observability (Shared Module)

Bu modül, Backend ve Celery Worker tarafından ortak kullanılan
Langfuse entegrasyonunu sağlar.

Kullanım:
    from shared.langfuse_client import get_langfuse, trace_llm_call, observe
...
# ============================================================================
# DOCUMENT PROCESSING TRACING - Used by Celery Worker
# ============================================================================
