...
const NAV_ITEMS = [
  ...
  { to: '/evolving', label: 'Evolving Agent', icon: BrainIcon },
  { to: '/chat', label: 'Soru Sor', icon: ChatIcon },
];
  ...
  return (
    <nav className="bg-white border-b border-slate-200 px-4 h-12 flex items-center justify-between shrink-0">
      <Link to="/dashboard" className="flex items-center gap-2 group">
        ...
        <span className="text-sm font-semibold text-slate-800 group-hover:text-indigo-600 transition-colors hidden sm:inline">
